...
module.exports = {
  AgrumentError: {
    "#constructor": {
      ...
      "should be an instance of the builtin Error": function () {
        expect(this.error).to.be.an.instanceof(Error);
      },

      "should be an instance of its class": function () {
      ...
      "should have a stack with the message and location the error was created":
        function () {
          ...
          expect(stackLines[1]).to.include("test/exceptions.test.js:11");
        },
    },
  },
  ...
  APIError: {
    "#constructor": {
      ...
      "should have a statusCode": function () {
        expect(this.error.statusCode).to.eql(401);
      },

      "should have request info": function () {
        expect((this.error.requestInfo || {}).method).to.eql(
          this.reqinfo.method
        );
        expect((this.error.requestInfo || {}).url).to.eql(this.reqinfo.url);
      },

      "should have an original error": function () {
